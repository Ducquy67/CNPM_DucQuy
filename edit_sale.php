    ...
    validate_fields($req_fields);
        if(empty($errors)){
          ...
          if( $result && $db->affected_rows() === 1){
                    ...
                    $session->msg('s',"Đơn hàng đã được cập nhật.");
                    redirect('edit_sale.php?id='.$sale['id'], false);
                  } else {
                    $session->msg('d',' Xin lỗi! Cập nhật đơn hàng thất bại!');
  ...
  <div class="panel">
    <div class="panel-heading clearfix">
     ...
     <div class="pull-right">
       <a href="sales.php" class="btn btn-primary">Hiển thị tất cả đơn hàng</a>
     </div>
    </div>
          ...
          <th> Hành động</th>
           ...
           <tbody  id="product_info">
              ...
              <form method="post" action="edit_sale.php?id=<?php echo (int)$sale['id']; ?>">
                ...
                <td>
                  <button type="submit" name="update_sale" class="btn btn-primary">Cập nhật đơn hàng</button>
                </td>
              </form>
              </tr>
           </tbody>
